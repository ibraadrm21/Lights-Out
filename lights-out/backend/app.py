...
MAPILLARY_TOKEN = os.environ.get("MAPILLARY_TOKEN", "MLY|25376847771955774|b578be85fc5f1e79dfbce7a633a4b457")
...
# Serve other static files (JS, CSS) if they are in public root or subfolders
@app.route("/<path:path>")
